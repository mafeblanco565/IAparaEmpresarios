    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl px-5 sm:px-8">
        ...
        <p className="mt-6 max-w-3xl text-pretty text-lg leading-relaxed text-white/70">
          3 niveles integrados en una sola ruta de formación: 100 horas Cátedra + 25 horas autónomas, desde los fundamentos hasta la automatización. Aprende, usa, aplica y automatiza con IA para que lleves tu negocio a otro nivel.
        </p>
