...
export default function Home() {
  return (
    <main>
      ...
      <section id="diplomado" className="section transformation-section immersive-diploma-section"><div className="tech-panel"><div className="tech-panel-top"><span className="mono-label">SYSTEM / IA-2026</span><span className="tech-live"><span className="status-dot" /> EN VIVO</span></div><div className="tech-core"><div className="core-ring ring-a" /><div className="core-ring ring-b" /><div className="core-center"><Hexagon size={34} strokeWidth={1.2} /><span>IA<br /><small>APLICADA</small></span></div><i className="node node-a" /><i className="node node-b" /><i className="node node-c" /></div><div className="tech-readout"><span>INPUT</span><strong>Tu realidad</strong><span className="readout-line" /><span>OUTPUT</span><strong>Más tiempo · mejores resultados</strong></div><div className="tech-footer"><span>PROCESSING</span><b>04 / 04</b><span className="progress-track"><span /></span></div></div><div className="transformation-copy"><p className="eyebrow">[ EL DIPLOMADO ]</p><h2>Aprende herramientas que<br /><em>hacen avanzar tu trabajo.</em></h2><p>La inteligencia artificial puede ayudarte a ahorrar tiempo, ordenar tus procesos, comunicar mejor tus ideas y entregar resultados más profesionales. Aquí aprendes a usarla con criterio en tu empresa, emprendimiento o profesión.</p><div className="benefit-grid"><div><Target size={22} /><strong>Casos de tu sector</strong><span>Lo que aprendes tiene contexto.</span></div><div><Workflow size={22} /><strong>Progreso medible</strong><span>De la idea a la implementación.</span></div><div><Sparkles size={22} /><strong>Formación con Calidad Certificada</strong><span>ISO 9001:2015, NTC 5555:2011, NTC 5581:2011, NTC 5666:2011.</span></div></div></div></section>
      ...
      <section id="cupo" className="signup-section"><div className="signup-panel"><div className="signup-copy"><p className="eyebrow">[ TU SIGUIENTE MOVIMIENTO ]</p><h2>Haz que tu trabajo<br /><em>avance contigo.</em></h2><p>Conversa con nuestro equipo, descubre cómo la IA puede ayudarte en tu contexto y aparta tu cupo para comenzar tu transformación.</p><a className="button button-light" href={whatsappUrl} target="_blank" rel="noreferrer"><MessageCircle size={18} /> Quiero comenzar mi transformación <ArrowUpRight size={17} /></a></div><div className="invitation-card"><span className="mono-label">ACCESO A LA RUTA · 2026</span><div className="invitation-orbit"><span>IA</span></div><strong>Tu empresa.<br /><em>Tu proceso.</em><br />Tu próxima ventaja.</strong><span className="invitation-meta">Cupos limitados · Hasta 20% de descuento</span></div></div></section>
