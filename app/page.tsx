  ...
  return (
    <>
      <header className="site-header reference-header">
        <a href="#inicio" className="brand reference-logo" aria-label="Multicómputo, inicio"><img src="/images/logo-dark-bg.png" alt="Multicómputo" /></a>
...
export default function Home() {
  return (
    <main>
      ...
      <section id="cupo" className="signup-section"><div className="signup-panel"><div className="signup-copy"><p className="eyebrow">[ TU SIGUIENTE MOVIMIENTO ]</p><h2>Haz que tu negocio<br /><em>se mueva primero.</em></h2><p>Conversa con nuestro equipo, conoce la ruta y aparta tu cupo para empezar a aplicar IA en tu propia empresa.</p><a className="button button-light" href={whatsappUrl} target="_blank" rel="noreferrer"><MessageCircle size={18} /> Quiero dar el siguiente paso <ArrowUpRight size={17} /></a></div><div className="invitation-card"><span className="mono-label">ACCESO A LA RUTA · 2026</span><div className="invitation-orbit"><span>IA</span></div><strong>Tu empresa.<br /><em>Tu proceso.</em><br />Tu próxima ventaja.</strong><span className="invitation-meta">Cupos limitados · Hasta 20% de descuento</span></div></div></section>
