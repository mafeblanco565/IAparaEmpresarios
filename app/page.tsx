...
export default function Home() {
  return (
    <main>
      ...
      <section id="diplomado" className="section transformation-section immersive-diploma-section"><div className="diploma-video-panel"><video autoPlay loop muted playsInline poster={`${basePath}/images/hero-bg.jpg`}><source src={`${basePath}/diplomado-ia.mp4`} type="video/mp4" /></video><div className="diploma-video-shade" /><div className="video-corner video-corner-top"><span className="mono-label">VISUAL / 01</span><span className="tech-live"><span className="status-dot" /> IA EN ACCIÓN</span></div><div className="video-corner video-corner-bottom"><div className="video-core-badge"><Hexagon size={24} strokeWidth={1.2} /><span>IA<br /><small>APLICADA</small></span></div><span className="mono-label">EMPRESA · EMPRENDIMIENTO · PROFESIÓN</span></div><div className="video-scanline" /></div><div className="transformation-copy"><p className="eyebrow">[ EL DIPLOMADO ]</p><h2>Aprende herramientas que<br /><em>hacen avanzar tu trabajo.</em></h2><p>La inteligencia artificial puede ayudarte a ahorrar tiempo, ordenar tus procesos, comunicar mejor tus ideas y entregar resultados más profesionales. Aquí aprendes a usarla con criterio en tu empresa, emprendimiento o profesión.</p><div className="benefit-grid"><div className="benefit-card"><div className="benefit-card-top"><span className="benefit-index">01 / 03</span><span className="benefit-status"><span className="status-dot" /> APLICADO</span></div><div className="benefit-icon"><Target size={22} /></div><strong>Casos de tu sector</strong><span>Lo que aprendes tiene contexto.</span><ArrowUpRight className="benefit-arrow" size={17} /></div><div className="benefit-card"><div className="benefit-card-top"><span className="benefit-index">02 / 03</span><span className="benefit-status"><span className="status-dot" /> MEDIBLE</span></div><div className="benefit-icon"><Workflow size={22} /></div><strong>Progreso medible</strong><span>De la idea a la implementación.</span><ArrowUpRight className="benefit-arrow" size={17} /></div><div className="benefit-card benefit-card-wide"><div className="benefit-card-top"><span className="benefit-index">03 / 03</span><span className="benefit-status"><span className="status-dot" /> CERTIFICADO</span></div><div className="benefit-icon"><Sparkles size={22} /></div><strong>Formación con Calidad Certificada</strong><span>ISO 9001:2015, NTC 5555:2011, NTC 5581:2011, NTC 5666:2011.</span><ArrowUpRight className="benefit-arrow" size={17} /></div></div></div></section>
